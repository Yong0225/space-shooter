#!/usr/bin/env python3
"""
Oregon Division Street / Richmond Leads Scraper
Collects F&B leads along SE Division Street and Richmond neighborhood, Portland OR
Output: Division Street / Richmond leads.xlsx  (Name | Area | Website | Email | Instagram | Facebook)

Resume-safe: writes to Excel + division_richmond_progress.json after EVERY lead.
Run: py scrap_division_richmond.py
      py scrap_division_richmond.py --reset   # clear progress and restart
"""
...
SEARCH_QUERIES = [
    ...
    "cafe SE Division Street Portland Oregon",
    "bar SE Division Street Portland Oregon",
    "food SE Division Street Portland Oregon",
    "coffee SE Division Street Portland Oregon",
    "bakery SE Division Street Portland Oregon",
    "pizza SE Division Street Portland Oregon",
    "brunch SE Division Street Portland Oregon",
    "ramen SE Division Street Portland Oregon",
    "sushi SE Division Street Portland Oregon",
    "tacos SE Division Street Portland Oregon",
    "burger SE Division Street Portland Oregon",
    "thai SE Division Street Portland Oregon",
    "vietnamese SE Division Street Portland Oregon",
    "mexican SE Division Street Portland Oregon",
    "japanese SE Division Street Portland Oregon",
    "korean SE Division Street Portland Oregon",
    "mediterranean SE Division Street Portland Oregon",
    "indian SE Division Street Portland Oregon",
    "chinese SE Division Street Portland Oregon",
    "vegan SE Division Street Portland Oregon",
    "vegetarian SE Division Street Portland Oregon",
    "brewery SE Division Street Portland Oregon",
    "wine bar SE Division Street Portland Oregon",
    "cocktail SE Division Street Portland Oregon",
    "ice cream SE Division Street Portland Oregon",
    "dessert SE Division Street Portland Oregon",
    # Richmond neighborhood
    "restaurant Richmond Portland Oregon",
    "cafe Richmond neighborhood Portland Oregon",
    "bar Richmond neighborhood Portland Oregon",
    "food Richmond Portland Oregon",
    "coffee shop Richmond Portland Oregon",
    "brunch Richmond Portland Oregon",
    "restaurant SE 20th Division Portland Oregon",
    "restaurant SE 30th Division Portland Oregon",
    "restaurant SE 39th Division Portland Oregon",
    "restaurant SE 50th Division Portland Oregon",
    # Nearby cross streets on Division
    "restaurant SE 11th Division Portland Oregon",
    "restaurant SE 12th Division Portland Oregon",
    "restaurant SE 15th Division Portland Oregon",
    "restaurant SE 28th Division Portland Oregon",
    "restaurant SE 32nd Division Portland Oregon",
    "restaurant SE 34th Division Portland Oregon",
    "restaurant SE 37th Division Portland Oregon",
    "restaurant SE 43rd Division Portland Oregon",
    "restaurant SE 52nd Division Portland Oregon",
    # ZIP codes for Richmond / Division area
    "restaurant Portland Oregon 97202",
    "cafe Portland Oregon 97202",
    "bar Portland Oregon 97202",
    "food Portland Oregon 97202",
    "restaurant Portland Oregon 97214",
    "cafe Portland Oregon 97214",
    # Bordering streets in Richmond
    "restaurant SE Clinton Portland Oregon",
    "cafe SE Clinton Portland Oregon",
    "restaurant SE Woodstock Portland Oregon",
    "restaurant SE Powell Portland Oregon",
    "cafe SE Powell Portland Oregon",
    "restaurant SE Cesar Chavez Portland Oregon",
    "restaurant SE 39th Ave Portland Oregon",
    # More cuisine types on Division
    "Ethiopian restaurant SE Division Portland Oregon",
    "Lebanese restaurant SE Division Portland Oregon",
    "French restaurant SE Division Portland Oregon",
    "Italian restaurant SE Division Portland Oregon",
    "American restaurant SE Division Portland Oregon",
    "seafood SE Division Portland Oregon",
    "sandwich SE Division Portland Oregon",
    "deli SE Division Portland Oregon",
    "food cart SE Division Portland Oregon",
    "food truck SE Division Portland Oregon",
]
...
def init_excel():
    ...
    ws = wb.active
    ws.title = "Division Street Richmond Leads"
    ws.append(HEADERS)
