#!/usr/bin/env python3
"""
Squirrel Hill Pittsburgh Pennsylvania Leads Scraper
Collects restaurant / food business leads in Squirrel Hill, Pittsburgh PA
Output: Squirrel Hill leads.xlsx  (Name | Area | Website | Email | Instagram | Facebook)

Resume-safe: writes to Excel + squirrel_hill_progress.json after EVERY lead.
Run: py scrap_squirrel_hill.py
      py scrap_squirrel_hill.py --reset   # clear progress and restart
"""
...
# ── Config ────────────────────────────────────────────────────────────────────
TARGET      = 9999
OUTPUT      = "Squirrel Hill leads.xlsx"
PROGRESS    = "squirrel_hill_progress.json"
HEADLESS    = False

SEARCH_QUERIES = [
    # Generic — Squirrel Hill
    "restaurant Squirrel Hill Pittsburgh Pennsylvania",
    "food Squirrel Hill Pittsburgh Pennsylvania",
    "cafe Squirrel Hill Pittsburgh Pennsylvania",
    "coffee shop Squirrel Hill Pittsburgh Pennsylvania",
    "bakery Squirrel Hill Pittsburgh Pennsylvania",
    "diner Squirrel Hill Pittsburgh Pennsylvania",
    "bistro Squirrel Hill Pittsburgh Pennsylvania",
    "food truck Squirrel Hill Pittsburgh Pennsylvania",
    # Forbes Avenue — main commercial strip
    "restaurant Forbes Avenue Pittsburgh Pennsylvania",
    "food Forbes Ave Pittsburgh Pennsylvania",
    "cafe Forbes Avenue Pittsburgh Pennsylvania",
    "restaurant Forbes Ave Squirrel Hill Pittsburgh",
    # Murray Avenue — other main strip
    "restaurant Murray Avenue Pittsburgh Pennsylvania",
    "food Murray Ave Pittsburgh Pennsylvania",
    "cafe Murray Avenue Pittsburgh Pennsylvania",
    "restaurant Murray Ave Squirrel Hill Pittsburgh",
    # Shady Avenue
    "restaurant Shady Avenue Pittsburgh Pennsylvania",
    "food Shady Ave Pittsburgh Pennsylvania",
    # Beechwood Blvd
    "restaurant Beechwood Blvd Pittsburgh Pennsylvania",
    "food Beechwood Boulevard Pittsburgh Pennsylvania",
    # Forward Avenue
    "restaurant Forward Avenue Pittsburgh Pennsylvania",
    "food Forward Ave Pittsburgh Pennsylvania",
    # Northumberland Street
    "restaurant Northumberland Street Pittsburgh Pennsylvania",
    "food Northumberland St Pittsburgh Pennsylvania",
    # Wilkins Avenue
    "restaurant Wilkins Avenue Pittsburgh Pennsylvania",
    "food Wilkins Ave Pittsburgh Pennsylvania",
    # Nearby neighborhoods that border Squirrel Hill
    "restaurant Shadyside Pittsburgh Pennsylvania",
    "food Shadyside Pittsburgh Pennsylvania",
    "cafe Shadyside Pittsburgh Pennsylvania",
    "restaurant Oakland Pittsburgh Pennsylvania",
    "food Oakland Pittsburgh Pennsylvania",
    "cafe Oakland Pittsburgh Pennsylvania",
    "restaurant Greenfield Pittsburgh Pennsylvania",
    "food Greenfield Pittsburgh Pennsylvania",
    "restaurant Point Breeze Pittsburgh Pennsylvania",
    "food Point Breeze Pittsburgh Pennsylvania",
    "restaurant Regent Square Pittsburgh Pennsylvania",
    "food Regent Square Pittsburgh Pennsylvania",
    "restaurant Swissvale Pittsburgh Pennsylvania",
    "restaurant Hazelwood Pittsburgh Pennsylvania",
    # Cuisine-specific — Squirrel Hill has a very diverse food scene
    "Chinese restaurant Squirrel Hill Pittsburgh Pennsylvania",
    "Chinese food Squirrel Hill Pittsburgh PA",
    "Chinese restaurant Forbes Ave Pittsburgh Pennsylvania",
    "Chinese restaurant Murray Ave Pittsburgh Pennsylvania",
    "Dim sum Pittsburgh Pennsylvania",
    "Taiwanese restaurant Pittsburgh Pennsylvania",
    "Vietnamese restaurant Squirrel Hill Pittsburgh Pennsylvania",
    "Pho Pittsburgh Squirrel Hill Pennsylvania",
    "Japanese restaurant Squirrel Hill Pittsburgh Pennsylvania",
    "Sushi Squirrel Hill Pittsburgh Pennsylvania",
    "Ramen Pittsburgh Pennsylvania",
    "Thai restaurant Squirrel Hill Pittsburgh Pennsylvania",
    "Indian restaurant Squirrel Hill Pittsburgh Pennsylvania",
    "Korean restaurant Pittsburgh Pennsylvania",
    "Filipino restaurant Pittsburgh Pennsylvania",
    "Malaysian restaurant Pittsburgh Pennsylvania",
    "Bubble tea Pittsburgh Pennsylvania",
    "Boba Pittsburgh Pennsylvania",
    "Hot pot Pittsburgh Pennsylvania",
    "Israeli restaurant Pittsburgh Pennsylvania",
    "Jewish deli Pittsburgh Pennsylvania",
    "Mediterranean restaurant Squirrel Hill Pittsburgh Pennsylvania",
    "Middle Eastern food Pittsburgh Pennsylvania",
    "Falafel Pittsburgh Pennsylvania",
    "Halal restaurant Pittsburgh Pennsylvania",
    "Ethiopian restaurant Pittsburgh Pennsylvania",
    "Mexican restaurant Squirrel Hill Pittsburgh Pennsylvania",
    "Taqueria Pittsburgh Pennsylvania",
    "Italian restaurant Squirrel Hill Pittsburgh Pennsylvania",
    "Pizza Squirrel Hill Pittsburgh Pennsylvania",
    "Burger Squirrel Hill Pittsburgh Pennsylvania",
    "Sandwich Squirrel Hill Pittsburgh Pennsylvania",
    "Breakfast Squirrel Hill Pittsburgh Pennsylvania",
    "Brunch Squirrel Hill Pittsburgh Pennsylvania",
    "Vegan restaurant Pittsburgh Squirrel Hill Pennsylvania",
    "Vegetarian Squirrel Hill Pittsburgh Pennsylvania",
    "Seafood Squirrel Hill Pittsburgh Pennsylvania",
    "BBQ Pittsburgh Pennsylvania",
    "Steak Pittsburgh Pennsylvania",
    "Ice cream Squirrel Hill Pittsburgh Pennsylvania",
    "Dessert Squirrel Hill Pittsburgh Pennsylvania",
    "Bakery Squirrel Hill Pittsburgh Pennsylvania",
    "Smoothie Pittsburgh Pennsylvania",
    "Gastropub Squirrel Hill Pittsburgh Pennsylvania",
    "Brewery Pittsburgh Pennsylvania east end",
    # ZIP codes covering Squirrel Hill
    "restaurant Pittsburgh Pennsylvania 15217",
    "restaurant Pittsburgh Pennsylvania 15232",
    "restaurant Pittsburgh Pennsylvania 15213",
    "food Pittsburgh Pennsylvania 15217",
    "food Pittsburgh Pennsylvania 15232",
    "cafe Pittsburgh Pennsylvania 15217",
    "cafe Pittsburgh Pennsylvania 15213",
    "restaurant Pittsburgh Pennsylvania 15206",
    "food Pittsburgh Pennsylvania 15206",
]
