#!/usr/bin/env python3
"""
Midtown Reno Nevada Leads Scraper
Collects restaurant / food business leads in Midtown Reno, NV
Output: Midtown Reno leads.xlsx  (Name | Area | Website | Email | Instagram | Facebook)

Resume-safe: writes to Excel + midtown_reno_progress.json after EVERY lead.
Run: py scrap_midtown_reno.py
      py scrap_midtown_reno.py --reset   # clear progress and restart
"""
...
# ── Config ────────────────────────────────────────────────────────────────────
TARGET      = 9999
OUTPUT      = "Midtown Reno leads.xlsx"
PROGRESS    = "midtown_reno_progress.json"
HEADLESS    = False

SEARCH_QUERIES = [
    # Generic — Midtown Reno
    "restaurant Midtown Reno Nevada",
    "food Midtown Reno Nevada",
    "cafe Midtown Reno Nevada",
    "bar Midtown Reno Nevada",
    "coffee shop Midtown Reno Nevada",
    "bakery Midtown Reno Nevada",
    "food truck Midtown Reno Nevada",
    "bistro Midtown Reno Nevada",
    "diner Midtown Reno Nevada",
    # South Virginia Street — main Midtown spine
    "restaurant South Virginia Street Reno Nevada",
    "food South Virginia Street Reno Nevada",
    "cafe South Virginia Street Reno Nevada",
    "restaurant S Virginia St Reno Nevada",
    "food S Virginia St Reno Nevada",
    # Plumas Street
    "restaurant Plumas Street Reno Nevada",
    "food Plumas St Reno Nevada",
    # California Avenue
    "restaurant California Avenue Reno Nevada",
    "food California Ave Reno Nevada",
    # Mt. Rose Street
    "restaurant Mt Rose Street Reno Nevada",
    "food Mt Rose St Reno Nevada",
    # Vassar Street / Holcomb Ave
    "restaurant Vassar Street Reno Nevada",
    "restaurant Holcomb Ave Reno Nevada",
    "food Holcomb Avenue Reno Nevada",
    # Wells Avenue corridor
    "restaurant Wells Avenue Reno Nevada",
    "food Wells Ave Reno Nevada",
    # Liberty / Center
    "restaurant Liberty Street Reno Nevada",
    "restaurant Center Street Reno Nevada",
    # Broader Reno — neighborhoods around Midtown
    "restaurant Reno Nevada Midtown District",
    "food Reno Nevada Midtown District",
    "restaurant downtown Reno Nevada",
    "food downtown Reno Nevada",
    "cafe downtown Reno Nevada",
    "restaurant near University of Nevada Reno",
    "food near UNR Reno Nevada",
    "restaurant Riverwalk Reno Nevada",
    "food Riverwalk District Reno Nevada",
    # Cuisine-specific
    "Mexican restaurant Midtown Reno Nevada",
    "Taqueria Reno Nevada Midtown",
    "Asian restaurant Midtown Reno Nevada",
    "Chinese restaurant Reno Nevada",
    "Vietnamese restaurant Reno Nevada",
    "Pho Reno Nevada",
    "Japanese restaurant Reno Nevada",
    "Sushi Reno Nevada",
    "Ramen Reno Nevada",
    "Thai restaurant Reno Nevada",
    "Indian restaurant Reno Nevada",
    "Korean restaurant Reno Nevada",
    "Filipino restaurant Reno Nevada",
    "Mediterranean restaurant Reno Nevada",
    "Middle Eastern food Reno Nevada",
    "Ethiopian restaurant Reno Nevada",
    "Italian restaurant Reno Nevada",
    "Pizza Reno Nevada Midtown",
    "Burger Reno Nevada Midtown",
    "Sandwich Reno Nevada Midtown",
    "Breakfast Reno Nevada Midtown",
    "Brunch Reno Nevada Midtown",
    "Vegan restaurant Reno Nevada",
    "Vegetarian restaurant Reno Nevada",
    "Seafood restaurant Reno Nevada Midtown",
    "BBQ Reno Nevada",
    "Steak Reno Nevada",
    "Ice cream Reno Nevada Midtown",
    "Dessert Reno Nevada Midtown",
    "Bubble tea Reno Nevada",
    "Boba Reno Nevada",
    "Smoothie Reno Nevada",
    "Juice bar Reno Nevada",
    "Bakery Reno Nevada",
    "Brewery Reno Nevada Midtown",
    "Gastropub Reno Nevada Midtown",
    "Wine bar Reno Nevada Midtown",
    # ZIP codes covering Midtown Reno
    "restaurant Reno Nevada 89502",
    "restaurant Reno Nevada 89503",
    "restaurant Reno Nevada 89509",
    "food Reno Nevada 89502",
    "food Reno Nevada 89503",
    "cafe Reno Nevada 89502",
    "cafe Reno Nevada 89509",
    # Surrounding areas that feed into Midtown
    "restaurant Midtown District Reno NV",
    "food Midtown District Reno NV",
    "restaurant South Reno Nevada",
    "restaurant Sparks Nevada",
    "food Sparks Nevada",
    "restaurant Victorian Square Sparks Nevada",
]
