#!/usr/bin/env python3
"""
Seven Hills Henderson Nevada Leads Scraper
Collects restaurant / food business leads in Seven Hills & surrounding Henderson, NV
Output: Seven Hills leads.xlsx  (Name | Area | Website | Email | Instagram | Facebook)

Resume-safe: writes to Excel + seven_hills_progress.json after EVERY lead.
Run: py scrap_seven_hills.py
      py scrap_seven_hills.py --reset   # clear progress and restart
"""
...
# ── Config ────────────────────────────────────────────────────────────────────
TARGET      = 9999
OUTPUT      = "Seven Hills leads.xlsx"
PROGRESS    = "seven_hills_progress.json"
HEADLESS    = False

SEARCH_QUERIES = [
    # Generic — Seven Hills / Henderson
    "restaurant Seven Hills Henderson Nevada",
    "food Seven Hills Henderson Nevada",
    "cafe Seven Hills Henderson Nevada",
    "restaurant Henderson Nevada",
    "food Henderson Nevada",
    "cafe Henderson Nevada",
    # Warm Springs Road — main commercial corridor near Seven Hills
    "restaurant Warm Springs Road Henderson Nevada",
    "food Warm Springs Rd Henderson Nevada",
    "cafe Warm Springs Road Henderson Nevada",
    "restaurant Warm Springs Henderson NV",
    # Gibson Road
    "restaurant Gibson Road Henderson Nevada",
    "food Gibson Rd Henderson Nevada",
    # Stephanie Street
    "restaurant Stephanie Street Henderson Nevada",
    "food Stephanie St Henderson Nevada",
    "restaurant Stephanie Henderson NV",
    # Eastern Avenue
    "restaurant Eastern Avenue Henderson Nevada",
    "food Eastern Ave Henderson Nevada",
    # St. Rose Parkway
    "restaurant St Rose Parkway Henderson Nevada",
    "food St Rose Pkwy Henderson Nevada",
    "restaurant Saint Rose Parkway Henderson Nevada",
    # Green Valley Parkway
    "restaurant Green Valley Parkway Henderson Nevada",
    "food Green Valley Pkwy Henderson Nevada",
    "restaurant Green Valley Henderson Nevada",
    "food Green Valley Henderson Nevada",
    # Pecos Road
    "restaurant Pecos Road Henderson Nevada",
    "food Pecos Rd Henderson Nevada",
    # Horizon Ridge Pkwy
    "restaurant Horizon Ridge Parkway Henderson Nevada",
    "food Horizon Ridge Henderson Nevada",
    # Sunset Road
    "restaurant Sunset Road Henderson Nevada",
    "food Sunset Rd Henderson Nevada",
    # Wigwam Pkwy / Lake Mead Pkwy
    "restaurant Wigwam Parkway Henderson Nevada",
    "restaurant Lake Mead Parkway Henderson Nevada",
    "food Lake Mead Pkwy Henderson NV",
    # Anthem area
    "restaurant Anthem Henderson Nevada",
    "food Anthem Henderson Nevada",
    "cafe Anthem Henderson Nevada",
    # MacDonald Ranch
    "restaurant MacDonald Ranch Henderson Nevada",
    "food MacDonald Ranch Henderson NV",
    # Green Valley Ranch area
    "restaurant Green Valley Ranch Henderson Nevada",
    "food Green Valley Ranch Henderson NV",
    # Downtown Henderson
    "restaurant downtown Henderson Nevada",
    "food downtown Henderson Nevada",
    "cafe downtown Henderson Nevada",
    # Cuisine-specific
    "Mexican restaurant Henderson Nevada",
    "Taqueria Henderson Nevada",
    "Chinese restaurant Henderson Nevada",
    "Vietnamese restaurant Henderson Nevada",
    "Pho Henderson Nevada",
    "Japanese restaurant Henderson Nevada",
    "Sushi Henderson Nevada",
    "Ramen Henderson Nevada",
    "Thai restaurant Henderson Nevada",
    "Indian restaurant Henderson Nevada",
    "Korean restaurant Henderson Nevada",
    "Filipino restaurant Henderson Nevada",
    "Mediterranean restaurant Henderson Nevada",
    "Middle Eastern food Henderson Nevada",
    "Italian restaurant Henderson Nevada",
    "Pizza Henderson Nevada",
    "Burger Henderson Nevada",
    "Sandwich Henderson Nevada",
    "Breakfast Henderson Nevada",
    "Brunch Henderson Nevada",
    "Vegan restaurant Henderson Nevada",
    "Vegetarian Henderson Nevada",
    "Seafood Henderson Nevada",
    "BBQ Henderson Nevada",
    "Steak Henderson Nevada",
    "Ice cream Henderson Nevada",
    "Dessert Henderson Nevada",
    "Bubble tea Henderson Nevada",
    "Boba Henderson Nevada",
    "Bakery Henderson Nevada",
    "Coffee shop Henderson Nevada",
    "Smoothie Henderson Nevada",
    "Food truck Henderson Nevada",
    "Gastropub Henderson Nevada",
    # ZIP codes covering Seven Hills / Henderson
    "restaurant Henderson Nevada 89052",
    "restaurant Henderson Nevada 89002",
    "restaurant Henderson Nevada 89014",
    "restaurant Henderson Nevada 89015",
    "restaurant Henderson Nevada 89044",
    "restaurant Henderson Nevada 89074",
    "food Henderson Nevada 89052",
    "food Henderson Nevada 89014",
    "cafe Henderson Nevada 89052",
    "cafe Henderson Nevada 89074",
]
