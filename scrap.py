...
# ── Config ────────────────────────────────────────────────────────────────────
TARGET      = 9999
OUTPUT      = "Novi leads.xlsx"
PROGRESS    = "novi_progress.json"
HEADLESS    = False   # keep visible so you can solve CAPTCHAs / intervene

# Queries for Novi, Michigan
SEARCH_QUERIES = [
    "restaurants Novi Michigan",
    "cafe Novi Michigan",
    "coffee shop Novi Michigan",
    "food Novi Michigan",
    "brunch Novi Michigan",
    "breakfast Novi Michigan",
    "pizza Novi Michigan",
    "bakery Novi Michigan",
    "sandwich Novi Michigan",
    "dessert Novi Michigan",
    "asian restaurant Novi Michigan",
    "chinese restaurant Novi Michigan",
    "indian restaurant Novi Michigan",
    "mediterranean Novi Michigan",
    "mexican restaurant Novi Michigan",
    "italian restaurant Novi Michigan",
    "sushi Novi Michigan",
    "burger Novi Michigan",
    "bar and grill Novi Michigan",
    "brewery Novi Michigan",
    "seafood Novi Michigan",
    "vegan Novi Michigan",
    "korean restaurant Novi Michigan",
    "thai restaurant Novi Michigan",
    "japanese restaurant Novi Michigan",
    "middle eastern Novi Michigan",
    "halal restaurant Novi Michigan",
    "restaurant Twelve Oaks Novi Michigan",
    "cafe Twelve Oaks Novi Michigan",
    "restaurant Main Street Novi Michigan",
    "food Main Street Novi Michigan",
    "restaurant Grand River Ave Novi Michigan",
    "cafe Grand River Ave Novi Michigan",
    "food Grand River Ave Novi Michigan",
    "restaurant Novi Michigan 48374",
    "cafe Novi Michigan 48374",
    "food Novi Michigan 48374",
    "restaurant Novi Michigan 48375",
    "cafe Novi Michigan 48375",
    "food Novi Michigan 48375",
    "restaurant Novi Michigan 48377",
    "cafe Novi Michigan 48377",
    "food Novi Michigan 48377",
    "restaurant Wixom Michigan",
    "cafe Wixom Michigan",
    "restaurant South Lyon Michigan",
    "restaurant Northville Michigan",
