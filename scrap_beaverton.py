#!/usr/bin/env python3
"""
Beaverton Oregon Leads Scraper
Collects restaurant / food business leads in Beaverton, OR
Output: Beaverton leads.xlsx  (Name | Area | Website | Email | Instagram | Facebook)

Resume-safe: writes to Excel + beaverton_progress.json after EVERY lead.
Run: py scrap_beaverton.py
      py scrap_beaverton.py --reset   # clear progress and restart
"""
...
# ── Config ────────────────────────────────────────────────────────────────────
TARGET      = 9999
OUTPUT      = "Beaverton leads.xlsx"
PROGRESS    = "beaverton_progress.json"
HEADLESS    = False

SEARCH_QUERIES = [
    # Generic restaurant / food
    "restaurant Beaverton Oregon",
    "food Beaverton Oregon",
    "cafe Beaverton Oregon",
    "coffee shop Beaverton Oregon",
    "bakery Beaverton Oregon",
    "food truck Beaverton Oregon",
    "bar and grill Beaverton Oregon",
    "diner Beaverton Oregon",
    "bistro Beaverton Oregon",
    # Downtown Beaverton
    "restaurant downtown Beaverton Oregon",
    "food downtown Beaverton Oregon",
    "restaurant Hall Blvd Beaverton Oregon",
    "restaurant SW Beaverton Hillsdale Hwy Oregon",
    # Beaverton-Hillsdale Highway
    "restaurant Beaverton Hillsdale Hwy Oregon",
    "food Beaverton Hillsdale Highway Oregon",
    # Cedar Hills / Cedar Mill
    "restaurant Cedar Hills Oregon",
    "restaurant Cedar Mill Oregon",
    "cafe Cedar Hills Oregon",
    # Tanasbourne / Sunset
    "restaurant Tanasbourne Oregon",
    "restaurant Sunset Beaverton Oregon",
    "food NW 185th Ave Beaverton Oregon",
    "restaurant Cornell Road Beaverton Oregon",
    # Walker Road / Canyon Road
    "restaurant Walker Road Beaverton Oregon",
    "restaurant Canyon Road Beaverton Oregon",
    "food SW Canyon Road Beaverton Oregon",
    # Allen Blvd / Farmington Road
    "restaurant Allen Blvd Beaverton Oregon",
    "restaurant Farmington Road Beaverton Oregon",
    "food Farmington Rd Beaverton Oregon",
    # TV Hwy / Tualatin Valley
    "restaurant TV Highway Beaverton Oregon",
    "restaurant Tualatin Valley Highway Oregon",
    "food TV Hwy Beaverton Oregon",
    # Asian food (Beaverton has a large Asian community)
    "Korean restaurant Beaverton Oregon",
    "Korean BBQ Beaverton Oregon",
    "Korean food Beaverton Oregon",
    "Chinese restaurant Beaverton Oregon",
    "Chinese food Beaverton Oregon",
    "Vietnamese restaurant Beaverton Oregon",
    "Pho Beaverton Oregon",
    "Japanese restaurant Beaverton Oregon",
    "Sushi Beaverton Oregon",
    "Ramen Beaverton Oregon",
    "Thai restaurant Beaverton Oregon",
    "Thai food Beaverton Oregon",
    "Indian restaurant Beaverton Oregon",
    "Indian food Beaverton Oregon",
    "Filipino restaurant Beaverton Oregon",
    "Taiwanese restaurant Beaverton Oregon",
    "Dim Sum Beaverton Oregon",
    "Hot pot Beaverton Oregon",
    "Bubble tea Beaverton Oregon",
    "Boba Beaverton Oregon",
    # Other cuisines
    "Mexican restaurant Beaverton Oregon",
    "Taqueria Beaverton Oregon",
    "Mediterranean restaurant Beaverton Oregon",
    "Middle Eastern food Beaverton Oregon",
    "Ethiopian restaurant Beaverton Oregon",
    "Pizza Beaverton Oregon",
    "Burger Beaverton Oregon",
    "Sandwich Beaverton Oregon",
    "Breakfast Beaverton Oregon",
    "Brunch Beaverton Oregon",
    "Vegan restaurant Beaverton Oregon",
    "Vegetarian Beaverton Oregon",
    "Seafood restaurant Beaverton Oregon",
    "Steak Beaverton Oregon",
    "BBQ Beaverton Oregon",
    "Ice cream Beaverton Oregon",
    "Dessert Beaverton Oregon",
    "Smoothie Beaverton Oregon",
    "Juice bar Beaverton Oregon",
    # ZIP codes
    "restaurant Beaverton Oregon 97005",
    "restaurant Beaverton Oregon 97006",
    "restaurant Beaverton Oregon 97007",
    "restaurant Beaverton Oregon 97008",
    "restaurant Beaverton Oregon 97075",
    "food Beaverton Oregon 97005",
    "food Beaverton Oregon 97006",
    "food Beaverton Oregon 97007",
    "cafe Beaverton Oregon 97006",
    "cafe Beaverton Oregon 97008",
    # Specific neighborhoods / landmarks
    "restaurant near Nike Beaverton Oregon",
    "restaurant Progress Ridge Beaverton Oregon",
    "restaurant Murrayhill Beaverton Oregon",
    "restaurant Cooper Mountain Beaverton Oregon",
    "restaurant Raleigh Hills Beaverton Oregon",
    "food Raleigh Hills Oregon",
    "restaurant Aloha Beaverton Oregon",
    "food Aloha Oregon",
]
