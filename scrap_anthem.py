#!/usr/bin/env python3
"""
Anthem Henderson Nevada Leads Scraper
Collects restaurant / food business leads in Anthem & surrounding Henderson, NV
Output: Anthem leads.xlsx  (Name | Area | Website | Email | Instagram | Facebook)

Resume-safe: writes to Excel + anthem_progress.json after EVERY lead.
Run: py scrap_anthem.py
      py scrap_anthem.py --reset   # clear progress and restart
"""
...
# ── Config ────────────────────────────────────────────────────────────────────
TARGET      = 9999
OUTPUT      = "Anthem leads.xlsx"
PROGRESS    = "anthem_progress.json"
HEADLESS    = False
...
SEARCH_QUERIES = [
    ...
    "coffee shop Anthem Henderson Nevada",
    "bakery Anthem Henderson Nevada",
    "food truck Anthem Henderson Nevada",
    "diner Anthem Henderson Nevada",
    # Anthem Parkway — main spine
    "restaurant Anthem Parkway Henderson Nevada",
    "food Anthem Pkwy Henderson Nevada",
    "cafe Anthem Parkway Henderson Nevada",
    # Bicentennial Pkwy
    "restaurant Bicentennial Pkwy Henderson Nevada",
    "food Bicentennial Parkway Henderson Nevada",
    # Volunteer Blvd
    "restaurant Volunteer Blvd Henderson Nevada",
    "food Volunteer Boulevard Henderson Nevada",
    # Horizon Ridge — southern stretch
    "restaurant Horizon Ridge Pkwy Henderson Nevada",
    "food Horizon Ridge Parkway Henderson Nevada",
    # St. Rose Pkwy — eastern Anthem commercial
    "restaurant St Rose Pkwy Henderson Nevada",
    "food Saint Rose Parkway Henderson Nevada",
    "restaurant St Rose Henderson NV",
    # Eastern Ave — southern Henderson
    "restaurant Eastern Avenue Henderson Nevada 89002",
    "food Eastern Ave Henderson Nevada south",
    # Inspirada — adjacent planned community
    "restaurant Inspirada Henderson Nevada",
    "food Inspirada Henderson NV",
    "cafe Inspirada Henderson Nevada",
    # Black Mountain area
    "restaurant Black Mountain Henderson Nevada",
    "food Black Mountain Henderson NV",
    # Anthem Hills / Anthem Country Club
    "restaurant Anthem Hills Henderson Nevada",
    "food Anthem Country Club Henderson Nevada",
    # Broader South Henderson
    "restaurant South Henderson Nevada",
    "food South Henderson Nevada",
    "cafe South Henderson Nevada",
    "restaurant Henderson Nevada south",
    # Henderson general (new queries not in Seven Hills scraper)
    "restaurant Henderson Nevada Galleria",
    "food Galleria at Sunset Henderson Nevada",
    "restaurant Henderson NV 89002",
    "restaurant Henderson NV 89044",
    "food Henderson NV 89044",
    "cafe Henderson NV 89044",
    "restaurant Henderson NV 89074",
    "food Henderson NV 89074",
    # Cuisine-specific
    "Mexican restaurant Anthem Henderson Nevada",
    "Taqueria Henderson Nevada south",
    "Chinese restaurant Anthem Henderson Nevada",
    "Vietnamese restaurant Anthem Henderson Nevada",
    "Pho Anthem Henderson Nevada",
    "Japanese restaurant Anthem Henderson Nevada",
    "Sushi Anthem Henderson Nevada",
    "Ramen Anthem Henderson Nevada",
    "Thai restaurant Anthem Henderson Nevada",
    "Indian restaurant Anthem Henderson Nevada",
    "Korean restaurant Anthem Henderson Nevada",
    "Filipino restaurant Henderson Nevada south",
    "Mediterranean restaurant Anthem Henderson Nevada",
    "Middle Eastern food Anthem Henderson Nevada",
    "Italian restaurant Anthem Henderson Nevada",
    "Pizza Anthem Henderson Nevada",
    "Burger Anthem Henderson Nevada",
    "Sandwich Anthem Henderson Nevada",
    "Breakfast Anthem Henderson Nevada",
    "Brunch Anthem Henderson Nevada",
    "Vegan restaurant Anthem Henderson Nevada",
    "Seafood Anthem Henderson Nevada",
    "BBQ Anthem Henderson Nevada",
    "Steak Anthem Henderson Nevada",
    "Ice cream Anthem Henderson Nevada",
    "Dessert Anthem Henderson Nevada",
    "Bubble tea Anthem Henderson Nevada",
    "Boba Anthem Henderson Nevada",
    "Smoothie Anthem Henderson Nevada",
    "Gastropub Anthem Henderson Nevada",
    "Brewery Henderson Nevada south",
    # ZIP codes specific to Anthem
    "restaurant Henderson Nevada 89052",
    "food Henderson Nevada 89052",
    "restaurant Henderson Nevada 89002",
    "food Henderson Nevada 89002",
    "cafe Henderson Nevada 89002",
    "restaurant Henderson Nevada 89015",
    "food Henderson Nevada 89015",
]
