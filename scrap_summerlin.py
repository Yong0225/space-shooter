#!/usr/bin/env python3
"""
Summerlin Las Vegas Nevada Leads Scraper
Collects restaurant / food business leads in Summerlin, NV
Output: Summerlin leads.xlsx  (Name | Area | Website | Email | Instagram | Facebook)

Resume-safe: writes to Excel + summerlin_progress.json after EVERY lead.
Run: py scrap_summerlin.py
      py scrap_summerlin.py --reset   # clear progress and restart
"""
...
# ── Config ────────────────────────────────────────────────────────────────────
TARGET      = 9999
OUTPUT      = "Summerlin leads.xlsx"
PROGRESS    = "summerlin_progress.json"
HEADLESS    = False

SEARCH_QUERIES = [
    # Generic — Summerlin
    "restaurant Summerlin Las Vegas Nevada",
    "food Summerlin Las Vegas Nevada",
    "cafe Summerlin Las Vegas Nevada",
    "coffee shop Summerlin Las Vegas Nevada",
    "bakery Summerlin Las Vegas Nevada",
    "food truck Summerlin Las Vegas Nevada",
    "diner Summerlin Las Vegas Nevada",
    "bistro Summerlin Las Vegas Nevada",
    # Downtown Summerlin — major dining hub
    "restaurant Downtown Summerlin Las Vegas",
    "food Downtown Summerlin Las Vegas",
    "cafe Downtown Summerlin Las Vegas",
    "restaurant Downtown Summerlin Nevada",
    "food Downtown Summerlin Nevada",
    # Rampart Blvd — main north-south corridor
    "restaurant Rampart Blvd Las Vegas Nevada",
    "food Rampart Boulevard Las Vegas Nevada",
    "cafe Rampart Blvd Las Vegas",
    "restaurant Rampart Las Vegas NV",
    # Town Center Drive
    "restaurant Town Center Drive Las Vegas Nevada",
    "food Town Center Dr Las Vegas Nevada",
    "restaurant Town Center Summerlin Nevada",
    # Hualapai Way
    "restaurant Hualapai Way Las Vegas Nevada",
    "food Hualapai Las Vegas Nevada",
    # Charleston Blvd — western stretch
    "restaurant Charleston Blvd Las Vegas Nevada west",
    "food Charleston Boulevard Summerlin Nevada",
    "restaurant W Charleston Las Vegas Nevada",
    # Sahara Ave — western stretch
    "restaurant Sahara Ave Las Vegas Nevada west",
    "food Sahara Avenue Summerlin Nevada",
    "restaurant W Sahara Las Vegas NV",
    # Lake Mead Blvd — western stretch
    "restaurant Lake Mead Blvd Las Vegas Nevada west",
    "food Lake Mead Boulevard Summerlin Nevada",
    # Alta Drive
    "restaurant Alta Drive Las Vegas Nevada",
    "food Alta Dr Las Vegas Nevada",
    # Durango Drive
    "restaurant Durango Drive Las Vegas Nevada",
    "food Durango Dr Las Vegas Nevada",
    "restaurant Durango Summerlin Nevada",
    # Fort Apache Road
    "restaurant Fort Apache Road Las Vegas Nevada",
    "food Fort Apache Rd Las Vegas Nevada",
    # Buffalo Drive
    "restaurant Buffalo Drive Las Vegas Nevada",
    "food Buffalo Dr Las Vegas Nevada",
    # Summerlin Pkwy area
    "restaurant Summerlin Parkway Las Vegas Nevada",
    "food Summerlin Pkwy Las Vegas NV",
    # Red Rock Casino area
    "restaurant Red Rock Casino Las Vegas Nevada",
    "food near Red Rock Casino Las Vegas",
    # Specific Summerlin villages/neighborhoods
    "restaurant The Trails Summerlin Las Vegas",
    "restaurant The Arbors Summerlin Las Vegas",
    "restaurant The Vistas Summerlin Las Vegas",
    "restaurant The Paseos Summerlin Las Vegas",
    "restaurant North Summerlin Las Vegas Nevada",
    "restaurant South Summerlin Las Vegas Nevada",
    # Cuisine-specific
    "Mexican restaurant Summerlin Las Vegas Nevada",
    "Taqueria Summerlin Las Vegas Nevada",
    "Chinese restaurant Summerlin Las Vegas Nevada",
    "Vietnamese restaurant Summerlin Las Vegas Nevada",
    "Pho Summerlin Las Vegas Nevada",
    "Japanese restaurant Summerlin Las Vegas Nevada",
    "Sushi Summerlin Las Vegas Nevada",
    "Ramen Summerlin Las Vegas Nevada",
    "Thai restaurant Summerlin Las Vegas Nevada",
    "Indian restaurant Summerlin Las Vegas Nevada",
    "Korean restaurant Summerlin Las Vegas Nevada",
    "Filipino restaurant Summerlin Las Vegas Nevada",
    "Mediterranean restaurant Summerlin Las Vegas Nevada",
    "Middle Eastern food Summerlin Las Vegas Nevada",
    "Italian restaurant Summerlin Las Vegas Nevada",
    "Pizza Summerlin Las Vegas Nevada",
    "Burger Summerlin Las Vegas Nevada",
    "Sandwich Summerlin Las Vegas Nevada",
    "Breakfast Summerlin Las Vegas Nevada",
    "Brunch Summerlin Las Vegas Nevada",
    "Vegan restaurant Summerlin Las Vegas Nevada",
    "Vegetarian Summerlin Las Vegas Nevada",
    "Seafood Summerlin Las Vegas Nevada",
    "BBQ Summerlin Las Vegas Nevada",
    "Steak Summerlin Las Vegas Nevada",
    "Ice cream Summerlin Las Vegas Nevada",
    "Dessert Summerlin Las Vegas Nevada",
    "Bubble tea Summerlin Las Vegas Nevada",
    "Boba Summerlin Las Vegas Nevada",
    "Smoothie Summerlin Las Vegas Nevada",
    "Gastropub Summerlin Las Vegas Nevada",
    "Brewery Summerlin Las Vegas Nevada",
    "Greek restaurant Summerlin Las Vegas Nevada",
    "American restaurant Summerlin Las Vegas Nevada",
    "Taiwanese Summerlin Las Vegas Nevada",
    "Dim sum Summerlin Las Vegas Nevada",
    "Hot pot Summerlin Las Vegas Nevada",
    # ZIP codes covering Summerlin
    "restaurant Las Vegas Nevada 89117",
    "restaurant Las Vegas Nevada 89128",
    "restaurant Las Vegas Nevada 89134",
    "restaurant Las Vegas Nevada 89135",
    "restaurant Las Vegas Nevada 89138",
    "restaurant Las Vegas Nevada 89144",
    "restaurant Las Vegas Nevada 89145",
    "restaurant Las Vegas Nevada 89146",
    "food Las Vegas Nevada 89135",
    "food Las Vegas Nevada 89134",
    "food Las Vegas Nevada 89144",
    "cafe Las Vegas Nevada 89135",
    "cafe Las Vegas Nevada 89117",
]
