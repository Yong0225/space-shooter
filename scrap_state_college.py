#!/usr/bin/env python3
"""
State College Pennsylvania Leads Scraper
Collects restaurant / food business leads in State College, PA
Output: State College leads.xlsx  (Name | Area | Website | Email | Instagram | Facebook)

Resume-safe: writes to Excel + state_college_progress.json after EVERY lead.
Run: py scrap_state_college.py
      py scrap_state_college.py --reset   # clear progress and restart
"""
...
# ── Config ────────────────────────────────────────────────────────────────────
TARGET      = 9999
OUTPUT      = "State College leads.xlsx"
PROGRESS    = "state_college_progress.json"
HEADLESS    = False

SEARCH_QUERIES = [
    # Generic
    "restaurant State College Pennsylvania",
    "food State College Pennsylvania",
    "cafe State College Pennsylvania",
    "coffee shop State College Pennsylvania",
    "bakery State College Pennsylvania",
    "food truck State College Pennsylvania",
    "diner State College Pennsylvania",
    "bistro State College Pennsylvania",
    "bar and grill State College Pennsylvania",
    # Downtown State College
    "restaurant downtown State College Pennsylvania",
    "food downtown State College Pennsylvania",
    "cafe downtown State College Pennsylvania",
    # College Avenue — main street
    "restaurant College Avenue State College Pennsylvania",
    "food College Ave State College Pennsylvania",
    "cafe College Avenue State College Pennsylvania",
    "restaurant E College Ave State College Pennsylvania",
    "restaurant W College Ave State College Pennsylvania",
    # Allen Street
    "restaurant Allen Street State College Pennsylvania",
    "food Allen St State College Pennsylvania",
    # Beaver Avenue
    "restaurant Beaver Avenue State College Pennsylvania",
    "food Beaver Ave State College Pennsylvania",
    # Atherton Street — commercial corridor
    "restaurant Atherton Street State College Pennsylvania",
    "food Atherton St State College Pennsylvania",
    "restaurant North Atherton Street State College Pennsylvania",
    "food N Atherton St State College Pennsylvania",
    "restaurant South Atherton State College Pennsylvania",
    # Calder Way
    "restaurant Calder Way State College Pennsylvania",
    "food Calder Way State College Pennsylvania",
    # Fraser Street / Pugh Street
    "restaurant Fraser Street State College Pennsylvania",
    "restaurant Pugh Street State College Pennsylvania",
    "food Pugh St State College Pennsylvania",
    # Heister Street / Garner Street
    "restaurant Heister Street State College Pennsylvania",
    "restaurant Garner Street State College Pennsylvania",
    # Penn State University area
    "restaurant Penn State University Pennsylvania",
    "food near Penn State University State College PA",
    "cafe near Penn State State College Pennsylvania",
    "restaurant near PSU State College Pennsylvania",
    # Nittany Mall / North Atherton commercial strip
    "restaurant Nittany Mall State College Pennsylvania",
    "food North Atherton State College Pennsylvania",
    # Patton Township
    "restaurant Patton Township State College Pennsylvania",
    "food Patton Township PA",
    # Harris Township / Boalsburg
    "restaurant Boalsburg Pennsylvania",
    "food Boalsburg PA",
    # Bellefonte (nearby)
    "restaurant Bellefonte Pennsylvania",
    "food Bellefonte PA",
    # Cuisine-specific
    "Mexican restaurant State College Pennsylvania",
    "Taqueria State College Pennsylvania",
    "Chinese restaurant State College Pennsylvania",
    "Chinese food State College PA",
    "Vietnamese restaurant State College Pennsylvania",
    "Pho State College Pennsylvania",
    "Japanese restaurant State College Pennsylvania",
    "Sushi State College Pennsylvania",
    "Ramen State College Pennsylvania",
    "Thai restaurant State College Pennsylvania",
    "Indian restaurant State College Pennsylvania",
    "Korean restaurant State College Pennsylvania",
    "Filipino restaurant State College Pennsylvania",
    "Mediterranean restaurant State College Pennsylvania",
    "Middle Eastern food State College Pennsylvania",
    "Italian restaurant State College Pennsylvania",
    "Pizza State College Pennsylvania",
    "Burger State College Pennsylvania",
    "Sandwich State College Pennsylvania",
    "Breakfast State College Pennsylvania",
    "Brunch State College Pennsylvania",
    "Vegan restaurant State College Pennsylvania",
    "Vegetarian State College Pennsylvania",
    "Seafood State College Pennsylvania",
    "BBQ State College Pennsylvania",
    "Steak State College Pennsylvania",
    "Ice cream State College Pennsylvania",
    "Dessert State College Pennsylvania",
    "Bubble tea State College Pennsylvania",
    "Boba State College Pennsylvania",
    "Smoothie State College Pennsylvania",
    "Gastropub State College Pennsylvania",
    "Brewery State College Pennsylvania",
    "Wings State College Pennsylvania",
    "Sub sandwich State College Pennsylvania",
    "Late night food State College Pennsylvania",
    "Ethiopian restaurant State College Pennsylvania",
    "Greek restaurant State College Pennsylvania",
    "American restaurant State College Pennsylvania",
    # ZIP codes
    "restaurant State College Pennsylvania 16801",
    "restaurant State College Pennsylvania 16802",
    "restaurant State College Pennsylvania 16803",
    "food State College Pennsylvania 16801",
    "food State College Pennsylvania 16802",
    "cafe State College Pennsylvania 16801",
    "cafe State College Pennsylvania 16803",
]
