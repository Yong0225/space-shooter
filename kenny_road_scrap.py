#!/usr/bin/env python3
"""
Kenny Road Leads Scraper
Collects restaurant/cafe leads from Kenny Road area, Columbus / Upper Arlington, OH
Output: Kenny Road leads.xlsx  (Name | Website | Email | Instagram | Facebook)

Resume-safe: writes to Excel + kenny_road_progress.json after EVERY lead.
Run: py kenny_road_scrap.py
      py kenny_road_scrap.py --reset   # clear progress and restart
"""
...
# ── Config ────────────────────────────────────────────────────────────────────
TARGET      = 9999
OUTPUT      = "Kenny Road leads.xlsx"
PROGRESS    = "kenny_road_progress.json"
HEADLESS    = False   # keep visible so you can solve CAPTCHAs / intervene

# Queries targeting Kenny Road and surrounding area (Upper Arlington / Columbus OH)
SEARCH_QUERIES = [
    # Direct Kenny Road queries
    "restaurants Kenny Road Columbus Ohio",
    "cafe Kenny Road Columbus Ohio",
    "coffee shop Kenny Road Columbus Ohio",
    "bar Kenny Road Columbus Ohio",
    "food Kenny Road Columbus Ohio",
    "restaurant Kenny Road Upper Arlington Ohio",
    # Upper Arlington (Kenny Road runs through UA)
    "restaurants Upper Arlington Ohio",
    "cafe Upper Arlington Ohio",
    "coffee shop Upper Arlington Ohio",
    "bar Upper Arlington Ohio",
    "brunch Upper Arlington Ohio",
    "breakfast Upper Arlington Ohio",
    "pizza Upper Arlington Ohio",
    "burger Upper Arlington Ohio",
    "sushi Upper Arlington Ohio",
    "italian restaurant Upper Arlington Ohio",
    "mexican restaurant Upper Arlington Ohio",
    "chinese restaurant Upper Arlington Ohio",
    "seafood Upper Arlington Ohio",
    "wine bar Upper Arlington Ohio",
    "cocktail bar Upper Arlington Ohio",
    "brewery Upper Arlington Ohio",
    "bakery Upper Arlington Ohio",
    "dessert Upper Arlington Ohio",
    "vegan Upper Arlington Ohio",
    "thai restaurant Upper Arlington Ohio",
    "indian restaurant Upper Arlington Ohio",
    "mediterranean Upper Arlington Ohio",
    "food Upper Arlington Ohio",
    # Cross streets near Kenny Road
    "restaurant Lane Ave Columbus Ohio",
    "restaurant Bethel Road Columbus Ohio",
    "restaurant Henderson Road Columbus Ohio",
    "restaurant Kinnear Road Columbus Ohio",
    "restaurant Olentangy River Road Columbus Ohio",
    "food Tremont Center Columbus Ohio",
    "restaurant Tremont Center Upper Arlington Ohio",
    "restaurant Arlington Center Columbus Ohio",
    # Zip codes for Kenny Road area
    "restaurants Columbus Ohio 43220",
    "cafe Columbus Ohio 43220",
    "food Columbus Ohio 43220",
    "restaurant Columbus Ohio 43220",
    "coffee shop Columbus Ohio 43220",
    "bar Columbus Ohio 43220",
    "brunch Columbus Ohio 43220",
    "breakfast Columbus Ohio 43220",
    "pizza Columbus Ohio 43220",
    "sushi Columbus Ohio 43220",
    "italian restaurant Columbus Ohio 43220",
    "mexican restaurant Columbus Ohio 43220",
    "burger Columbus Ohio 43220",
    "seafood Columbus Ohio 43220",
    "wine bar Columbus Ohio 43220",
    "brewery Columbus Ohio 43220",
    "bakery Columbus Ohio 43220",
    "vegan Columbus Ohio 43220",
    "thai Columbus Ohio 43220",
    "indian Columbus Ohio 43220",
    # Zip 43221 (also Upper Arlington)
    "restaurant Columbus Ohio 43221",
    "food Columbus Ohio 43221",
    "cafe Columbus Ohio 43221",
    "bar Columbus Ohio 43221",
    # Zip 43235 (northwest Columbus, near Kenny Road north end)
    "restaurant Columbus Ohio 43235",
    "food Columbus Ohio 43235",
    "cafe Columbus Ohio 43235",
    # Zip 43214 (Clintonville, adjacent north)
    "restaurant Columbus Ohio 43214",
    "food Columbus Ohio 43214",
    "cafe Columbus Ohio 43214",
]
