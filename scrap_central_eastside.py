#!/usr/bin/env python3
"""
Central Eastside Portland Oregon Leads Scraper
Collects restaurant / food business leads in Central Eastside, Portland OR
Output: Central Eastside leads.xlsx  (Name | Area | Website | Email | Instagram | Facebook)

Resume-safe: writes to Excel + central_eastside_progress.json after EVERY lead.
Run: py scrap_central_eastside.py
      py scrap_central_eastside.py --reset   # clear progress and restart
"""
...
# ── Config ────────────────────────────────────────────────────────────────────
TARGET      = 9999
OUTPUT      = "Central Eastside leads.xlsx"
PROGRESS    = "central_eastside_progress.json"
HEADLESS    = False

SEARCH_QUERIES = [
    # Generic
    "restaurant Central Eastside Portland Oregon",
    "food Central Eastside Portland Oregon",
    "cafe Central Eastside Portland Oregon",
    "bar Central Eastside Portland Oregon",
    "food cart Central Eastside Portland Oregon",
    # SE Grand Ave / MLK — main commercial spine
    "restaurant SE Grand Ave Portland Oregon",
    "food SE Grand Ave Portland Oregon",
    "restaurant SE MLK Blvd Portland Oregon",
    "food SE MLK Portland Oregon",
    "restaurant SE Martin Luther King Jr Blvd Portland Oregon",
    # SE Burnside / Stark / Oak / Pine
    "restaurant SE Burnside Portland Oregon",
    "food SE Burnside Street Portland Oregon",
    "restaurant SE Stark Portland Oregon",
    "restaurant SE Oak Portland Oregon",
    "restaurant SE Pine Portland Oregon",
    "food SE Stark Street Portland Oregon",
    # SE Morrison / Belmont
    "restaurant SE Morrison Portland Oregon",
    "food SE Morrison Street Portland Oregon",
    "restaurant SE Belmont Portland Oregon",
    "food SE Belmont Portland Oregon",
    # SE Hawthorne
    "restaurant SE Hawthorne Portland Oregon",
    "food SE Hawthorne Blvd Portland Oregon",
    "cafe SE Hawthorne Portland Oregon",
    # SE Division
    "restaurant SE Division Portland Oregon",
    "food SE Division Street Portland Oregon",
    "cafe SE Division Portland Oregon",
    # SE Clinton
    "restaurant SE Clinton Portland Oregon",
    "food SE Clinton Street Portland Oregon",
    # SE Water Ave / industrial
    "restaurant SE Water Ave Portland Oregon",
    "food SE Water Avenue Portland Oregon",
    "brewery Central Eastside Portland Oregon",
    "distillery Central Eastside Portland Oregon",
    # SE 6th–12th corridor
    "restaurant SE 6th Ave Portland Oregon",
    "restaurant SE 7th Ave Portland Oregon",
    "restaurant SE 8th Ave Portland Oregon",
    "restaurant SE 11th Ave Portland Oregon",
    "restaurant SE 12th Ave Portland Oregon",
    "food SE 6th Portland Oregon",
    # SE Powell
    "restaurant SE Powell Portland Oregon",
    "food SE Powell Blvd Portland Oregon",
    # Buckman / Hosford-Abernethy neighborhoods
    "restaurant Buckman Portland Oregon",
    "food Buckman Portland Oregon",
    "restaurant Hosford Abernethy Portland Oregon",
    # Clinton neighborhood
    "restaurant Clinton Portland Oregon",
    "cafe Clinton Portland Oregon",
    # Cuisine-specific
    "Korean restaurant Central Eastside Portland Oregon",
    "Chinese restaurant Central Eastside Portland Oregon",
    "Vietnamese restaurant Portland Central Eastside Oregon",
    "Pho SE Portland Oregon",
    "Japanese restaurant Central Eastside Portland Oregon",
    "Sushi SE Portland Oregon",
    "Ramen SE Portland Oregon",
    "Thai restaurant SE Portland Oregon",
    "Indian restaurant SE Portland Oregon",
    "Mexican restaurant SE Portland Oregon",
    "Taqueria SE Portland Oregon",
    "Ethiopian restaurant SE Portland Oregon",
    "Mediterranean SE Portland Oregon",
    "Middle Eastern SE Portland Oregon",
    "Filipino restaurant SE Portland Oregon",
    "Taiwanese SE Portland Oregon",
    "Pizza SE Portland Oregon",
    "Burger SE Portland Oregon",
    "Breakfast SE Portland Oregon",
    "Brunch SE Portland Oregon",
    "Vegan restaurant SE Portland Oregon",
    "Vegetarian SE Portland Oregon",
    "Seafood SE Portland Oregon",
    "BBQ SE Portland Oregon",
    "Sandwich SE Portland Oregon",
    "Bakery SE Portland Oregon",
    "Coffee shop SE Portland Oregon",
    "Bubble tea SE Portland Oregon",
    "Boba SE Portland Oregon",
    "Dessert SE Portland Oregon",
    "Ice cream SE Portland Oregon",
    "Food truck SE Portland Oregon",
    # ZIP codes covering Central Eastside
    "restaurant Portland Oregon 97214",
    "restaurant Portland Oregon 97202",
    "restaurant Portland Oregon 97232",
    "food Portland Oregon 97214",
    "food Portland Oregon 97202",
    "cafe Portland Oregon 97214",
    "restaurant Portland Oregon 97215",
    "food Portland Oregon 97215",
    # Specific landmarks / clusters
    "restaurant Cartopia Portland Oregon",
    "food cart SE 12th Hawthorne Portland Oregon",
    "food cart SE Division Portland Oregon",
    "food cart SE Belmont Portland Oregon",
    "restaurant Produce Row Portland Oregon",
    "food Produce Row Portland Oregon",
    "restaurant Richmond Portland Oregon",
    "food Richmond Portland Oregon",
    "restaurant Ladd's Addition Portland Oregon",
]
...
def init_excel():
    ...
    ws = wb.active
    ws.title = "Central Eastside Leads"
    ws.append(HEADERS)
